...
<div class="col-sm-5">
    <form method="POST" data-toggle="validator"   role="form">
        <div class="form-group col-sm-8 ">
            ...
            <input type="text" class="form-control" id="pack_name" name="pack_name" value="<?php echo $pack; ?>" readonly required>
            <input type="hidden" class="form-control" id="pack_id" name="pack" value="<?php echo $pack_id; ?>" readonly required>
	...
	if($pre > $today){
    	...
    	<input type="hidden" id="dtp_input1" name="expiry" value="<?php echo $newDate; ?>"/><br/>
            ...
            <br>
            <button id="sub_btn" <?php $dis=date(strtotime("+5 days")); if( $pre> $dis){echo "disabled";} ?> onclick="ExtentFun()" class="btn btn-success">Renew</button>
        </div>
    </form>
</div>
