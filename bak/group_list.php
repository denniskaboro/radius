    ...
    <table class="table table-bordered" id="btrc">
		...
		<td>
		 <div style="float:left; padding:5px;" id='dashboard<?php echo $name; ?>'>
                <?php if($f['dashboard']=="1"){ echo "show"; }else{ echo "hide"; } ?>
                </div>
		...
		<?php if($f['client_portal']=="1"){ echo "show"; }else{ echo "hide"; } ?>
		</div>
		<button class="btn-danger" onclick="SendData('0','client_portal','<?php echo $name; ?>')">Hide</button>
                <button class="btn-success" onclick="SendData('1','client_portal','<?php echo $name; ?>')">Show</button>
		</td>
		<td>
