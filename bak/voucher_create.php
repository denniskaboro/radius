...
if (isset($_POST['create'])) {
    ...
    if ($type == '1') {
        ...
        $vou = "INSERT INTO `voucher` (`package_name`,`voucher_name`,`total_user`,`voucher_type`,`amount`,`mbps`,`total_limit`,`deadline`,`supplier_id`) VALUES('$name','$profile','$num','Bandwidth Pack','$amt','$speed','$band $limit','$dead','$sup_id')";
        mysqli_query($con,$vou);
    ...
    mysqli_query($con,$sq);
    $sq1 = "INSERT INTO `radgroupreply` (`groupname`,`attribute`,`op`,`value`) VALUES('$profile','Acct-Interim-Interval','=','120')";
    mysqli_query($con,$sq1);
    if ($usr) {
        $msg = "Voucher Created...";
        $API->log($admin_id, $wh, $num . "Voucher Created");
    }
}
...
<div class="col-sm-5">
    <form data-toggle="validator" role="form" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="inputVou" name="num" placeholder="How many voucher you want to genarate" required>
        </div>
        <div class="form-group">
