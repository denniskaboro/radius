            ...
            <div class="container">
                <div class="flexible-widgets row">
                    <div class="widget-section widget widget_text wow fadeInUpShort col-md-8 col-md-offset-2 mb-xl text-center">
                        <div class="widget-wrap"><b>
                            <h2 class="widget-title primary-text-dark"><b><u>Our Coverage</b></u></h2>
                            <div class="textwidget">
                                <p class="text-lead primary-text-dark">
                                <h2><span>Access High Speed Internet Access </br></span></h2>
                                <div id="container">
                                    <div class="clear"></div>
                                    <div class="l-block">
                                        <h2><U><B>Hotspot Coverage</b></u></h2>
                                        <ul>
                                            <li>Githurai 44 Sonic Area & its Enviros</li>
                                        </ul>

                                        <h2><u><b>Point to Point Coverage</b></u></h2>
                                        <ul style="list-style-type:disc;">
                                            <li>Githurai 44, Githuari 45, Kamuthi</li>
                                            <li>Zimmerman, Roysambu,Maziwa</li>
                                            <!-- <li>Kamuthi, Maziwa</li> -->
                                            <li>Kahawa West, Kahawa Wendani</li>
                            ...
                            <!--l-block
                                   <!-- <p>Welcome to Netcom Internet Service provider. We are offer our services within  -->
                            <!-- <ul>  -->
                            <!-- <li>Githurai 44</li> -->
                            <!-- <li>Githurai 45 </li> -->
                            <!-- <li>Zimmerman</li> -->
                            ...
                            <!-- <li>Kamuthi & Maziwa</li> -->
                            <!-- </ul> -->
                            <!-- We provide Point to Point wireless internet connection and Wifi. -->
                            <!-- </p> -->
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card card-light">
                                <div class="flexible-widgets row popup-gallery">
                                    <div class="widget-wrap">
                                        <div class="textwidget">
                                            <div class="card card-light">
                                                <!-- <div class="card-media"><a href="assets\img\map.png" class="popup-gallery-link"><img src="assets\img\map.png" alt="" class="card-img"></a></div> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <nav class="site-footer-social-nav mb-lg">
                            <ul class="site-footer-social-menu list-inline ml-0">
                                ...
                                <li data-wow-delay="200ms" class="menu-item px-md wow fadeInUpShort"><a
                                        href="https://twitter.com/" target="_blank" class="primary-text-light"><span>Twitter</span></a>
                                </li>
