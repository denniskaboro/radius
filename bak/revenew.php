...
<nav aria-label="Page navigation">
    <ul class="pagination">
        ...
        if ($currentPage != $firstPage) { ?>
            <li class="page-item">
                <a class="page-link"
                   ...
                   tabindex="-1" aria-label="Previous" style="width:50px;height:40px;padding:10px;background:#ddd;color:black;">
                    <span aria-hidden="true">First</span>
                </a>
            </li>
            <li class="page-item"><a class="page-link"
                                     href="?page=<?php echo ($currentPage - 1) . "&id=" . $id . "&start=" . $start . "&end=" . $end; ?>" style="width:50px;border: 1px dotted;color:black;height:40px;padding:10px;background:#ddd;"><<</a></li>
        <?php } ?>
        <?php if ($lastPage < 5) {
        ...
        if ($compare != $lastPage) { ?>
            <li class="page-item"><a class="page-link"
                                     href="?page=<?php echo ($compare + 1) . "&id=" . $id . "&start=" . $start . "&end=" . $end; ?>"  style="width:50px;color:black;height:40px;border: 1px dotted;padding:10px;background:#ddd;">
                    >> </a></li>
            <li class="page-item">
                <a class="page-link"
                   href="?page=<?php echo $lastPage . "&id=" . $id . "&start=" . $start . "&end=" . $end; ?>"
                   aria-label="Next"  style="width:50px;height:40px;padding:10px;border: 1px dotted;color:black;background:#ddd;">
