...
<form method="POST" enctype="multipart/form-data">
    <div class="form-group col-md-2">
        ...
        <button type="submit" name="sort" style="padding: 6px 12px !important; font-size: 15px !important;" class="btn btn-primary">Search</button>
    </div>
</form>
        ...
        while ($j = mysqli_fetch_array($r)) {
            ...
            <tr>
                ...
                <?php if ($per == "Full" || $per == "Admin") { ?>
                    <td><a class="btn btn-danger" id="link" href="optional.php?id=<?php echo $j['id']; ?>&name=<?php echo $reference;?>">
