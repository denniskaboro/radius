...
$exp=$f['deadline'];
?>
<button class="btn btn-success" onclick="CreatePDFfromHTML()" style="width:70px;height:30px;padding: 5px;">Print</button>
<div class="col-lg-12 col-md-12 col-sm-12" id="pr" >
    ...
    $user = $j['username'];
    ?>
    <div class="col-lg-2 col-md-3 col-sm-3" style="border:1px solid #0d8d5c !important;color: black;margin-top: 10px!important; margin-left: 8px !important; background: rgb(248,241,255);">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <img src="site/<?php echo $site_logo; ?>" width="100%" height="60px">
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12" style="border-bottom:2px solid black;border-top:2px solid black;margin: 0px!important;padding: 0px !important;">
                <h5>SUBSCRIPTION</h5>
                <h5 style="font-weight: bold;">DURATION: <?php if($duration==null){ echo "UNLIMITED";}else{ echo $duration; } ?></h5>
                <h6 style="font-weight: bold;">DOWNLOAD: <?php if($limit==null){ echo "UNLIMITED";}else{ echo $limit; } ?></h6>
