...
<div class="col-sm-6">
    ...
    <form data-toggle="validator" role="form" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputFullname" name="fullname" value="<?php echo $f['full_name']?>" readonly>
            <input type="hidden" class="form-control" id="inputFullname" name="sup_id" value="<?php echo $f['supplier_id']?>" readonly>
        </div>
        <div class="form-group">
            <label for="inputDivision" class="control-label">Address</label>
            <input type="text" class="form-control" id="inputFullname" name="address" value="<?php echo $f['address']?>" readonly>
        </div>
        <div class="form-group">
            <label for="inputRoad" class="control-label">Contact No.</label>
            <input type="text" class="form-control" id="inputFullname" name="mobile" value="<?php echo $f['mobile']?>" required>
        </div>
        <div class="form-group">
	...
	Please add a problem or type problem bellow
            <textarea rows="4" cols="50"  class="form-control" id="problem" name="problem" placeholder="Type Your Problem Here..." ></textarea>
        </div>
        <div class="form-group">
