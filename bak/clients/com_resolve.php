...
<table class="table table-bordered" id="btrc">
    ...
    <tbody>
    <?php
    $sql = "SELECT * FROM resolved WHERE home_user='$username'  ORDER BY id DESC ";
    ...
    while ($j = mysqli_fetch_array($r)) {
        ...
        <tr>
            ...
            <td><button class="btn btn-primary" onClick='myValue(this.id)' id="<?php  echo $j['attachment']; ?>">Prob.</button>
                <button class="btn btn-primary" onClick='myValue(this.id)' id="<?php  echo $j['feedback_attachment']; ?>">Res.</button></td>
