    ...
    <table class="table table-bordered">
        ...
        if (isset($_GET['name'])) {
            ...
            if ($rr > 0) {
                ...
                $group = "No Package Set";
                echo "<h4 style='color:red'>" . $group . "</h4>";
            }
            $table = ["radgroupcheck", "radgroupreply"];
            foreach ($table as $tab) {
                $sq = "SELECT * FROM $tab WHERE groupname='$group'  ";
...
<div class="col-md-12 col-lg-12 col-sm-12">
    <table class="table table-bordered" id="btrc">
        ...
        $sql = "SELECT * FROM radpostauth WHERE username= '$name' ORDER BY id DESC ";
        $r = mysqli_query($con, $sql) or $msg = mysqli_error($con);
        while ($f = mysqli_fetch_array($r)) {
            ...
            <tr>
                ...
                <td>
                    <btn class="btn btn-danger" onclick="Select(<?php echo $f['id']; ?>)">
                        <i class="icon-edit"><span class="glyphicon glyphicon-off"></span></i></btn>
                </td>
            </tr>
        <?php } ?>
        </tbody>
...
<div class="col-lg-12 col-md-10">
    <form enctype="multipart/form-data">
        <select onchange="location = this.options[this.selectedIndex].value;">
            <option selected="" value="user_statistics.php?page=1&amp;entries=15&amp;name=<?php echo $name; ?>">Select
            </option>
            <option value="user_statistics.php?page=1&amp;entries=25&amp;name=<?php echo $name; ?>">25</option>
            <option value="user_statistics.php?page=1&amp;entries=50&amp;name=<?php echo $name; ?>">50</option>
            <option value="user_statistics.php?page=1&amp;entries=100&amp;name=<?php echo $name; ?>">100</option>
            <option value="user_statistics.php?page=1&amp;entries=250&amp;name=<?php echo $name; ?>">250</option>
            <option value="user_statistics.php?page=1&amp;entries=500&amp;name=<?php echo $name; ?>">500</option>
            <option value="user_statistics.php?page=1&amp;entries=All&amp;name=<?php echo $name; ?>">ALL</option>
        </select>
    </form>
    <h3>Usage History</h3>
    <table class="table table-bordered">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination" style="height:40px;">
            ...
            if ($currentPage != $firstPage) { ?>
                <li class="page-item">
                    <a class="page-link"
                       ...
                       style="width:50px;height:40px;padding:10px;border:1px solid;background:#ddd;color:black;">
                        <span aria-hidden="true">First</span>
                    </a>
                </li>
                <li class="page-item"><a class="page-link"
                                         href="?page=<?php echo ($currentPage - 1) . "&entries=" . $showRecordPerPage . "&name=" . $name; ?>"
                                         style="width:50px;border:1px solid;height:40px;padding:10px;background:#ddd;color:black;"><<
                    </a></li>
            <?php } ?>
            <?php if ($lastPage < 5) {
            ...
            if ($compare != $lastPage) { ?>
                <li class="page-item"><a class="page-link"
                                         href="?page=<?php echo ($compare + 1) . "&entries=" . $showRecordPerPage . "&name=" . $name; ?>"
                                         style="width:50px;border:1px solid;height:40px;padding:10px;background:#ddd;color:black;">
                        >> </a></li>
                <li class="page-item">
                    <a class="page-link"
