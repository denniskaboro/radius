...
<div style="float:right; color:red;">
    <form method="POST" enctype="multipart/form-data">
        <div class="col-lg-12">
            <input type="text" class="form-control" id="inputStart" placeholder="Search here" name="value"
                   style="height:35px !important;background: #141035 !important;color:#fff6fe !important;">
            <input type="submit" value="Search" name="search" class="btn"
                   style="float: right;background: rgba(59,143,17,0.8) !important;height:30px !important;color:#fff6fe !important;padding: 5px;margin: 5px;"/>
        </div>
    </form>
</div>
<?php
 ...
 or address LIKE '%$val%' or create_date LIKE '%$val%' or supplier_id LIKE '%$val%' ";
        ...
        while ($f = mysqli_fetch_array($r)) {
            ...
            <tr>
                ...
                <?php if ($dept != "Visitor") { ?>
                    <td><a style=" color: #e2b9db;" href="supplier_list.php?sort=<?php echo $sup; ?>"
    ...
    <ul class="pagination" style="height:40px;">
        ...
        if ($currentPage != $firstPage) { ?>
            ...
            <li class="page-item"><a class="page-link"
                                     href="?page=<?php echo ($currentPage - 1) . "&entries=" . $showRecordPerPage . "&sear=" . $val; ?>"
        ...
        if ($compare != $lastPage) { ?>
            <li class="page-item"><a class="page-link"
                                     href="?page=<?php echo ($compare + 1) . "&entries=" . $showRecordPerPage . "&sear=" . $val; ?>"
                                     style="width:50px;border:1px solid;height:40px;padding:10px;background:#ddd;color:black;">
                    >> </a></li>
            <li class="page-item">
                <a class="page-link"
