            ...
            <div class="card-body">
                <form data-toggle="validator" role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
                        ...
                        <textarea rows="2" class="form-control" placeholder="http://180.210.181.218/api/success.php"
                    ...
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
                        ...
                        <textarea rows="2" class="form-control" name="payment_url"
                                  placeholder="https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest"
                                  required></textarea>
                    </div>
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
                        <label class="control-label">Token URL *</label>
                        <textarea rows="2" class="form-control" name="token_url"
                                  placeholder="https://api.safaricom.co.ke/oauth/v1/generate" required></textarea>
                    </div>
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
                        <label class="control-label">Query URL *</label>
                        <textarea rows="2" class="form-control" name="queryURL"
                                  placeholder="https://api.safaricom.co.ke/mpesa/stkpushquery/v1/query"
                                  required></textarea>
                    </div>
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
