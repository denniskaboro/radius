...
<h4 style="color: red">Please wait, we will update your package after verify the payment status within 5 Minutes or you
    can check manually if you payment</h4>
<table class="table table-bordered" id="btrc">
    ...
    while ($j = mysqli_fetch_array($r)) {
        ...
        <tr id="<?php echo $id; ?>">
            ...
            <td>
                <button onclick="Payment('<?php echo $usr; ?>','<?php echo $id; ?>')" class="btn btn-danger">Update
                </button>
            </td>
