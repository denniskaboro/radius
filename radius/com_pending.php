...
<table class="table table-bordered" id="btrc">
    ...
    while ($j = mysqli_fetch_array($r)) {
        ...
        <tr><?php if ($dept != "Visitor") { ?>
            ...
            <td>
                <button class="btn btn-primary" onClick='myValue(this.id)' id="<?php echo $j['attachment']; ?>">Show
                </button>
            </td>
            ...
            <?php if ($per != "Read") { ?>
                <?php if ($j['status'] == "Working") { ?>
                    <td>
                        <button class="btn btn-danger" id="<?php echo $j['id']; ?>" onclick="End(this.id)"
                                style="color: #ffffff;">End
                        </button>
                    </td>
                <?php } else { ?>
                    <td>
                        <button class="btn btn-success" id="<?php echo $j['id']; ?>" onclick="Start(this.id)"
                                style="color: #ffffff;">Start
                        </button>
                    </td>
                <?php } ?>
...
<div class="form-popup" id="endForm">
    <form method="post" enctype="multipart/form-data" class="form-container">
        ...
        <div class="form-group">
            <label for="inputIP" class="control-label">Cause of Problem</label>
            <input type="text" class="form-control" id="inputProb" value='' name="problem"
                   placeholder="Found Problem Details">
