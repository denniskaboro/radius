...
if (isset($_POST['create'])) {
    if ($per == 'Full' || $per == 'Admin') {
        ...
        if ($_FILES["portal"]["name"]) {
            ...
            if ($main_ext == "jpg" || $main_ext == "png" || $main_ext == "jpeg") {
            ...
            <div class="card-body">
                <form data-toggle="validator" role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
                        ...
                        <input type="file" class="form-control" name="portal">
                    ...
                    <div class="form-group col-lg-8 col-md-8 col-sm-8">
                        <button type="submit" style="padding: 10px;width: 70px; height: 40px;" name="create"
