...
<div class="col-lg-12">
    ...
    <table class="table table-bordered " id="btrc">
        ...
        <tr>
            ...
            <td style="background-color: rgba(24,43,84,0.92); color: #ffffff; font-size:16px;"><?php echo $g_bw_total; ?>
                Mbps
            </td>
            <td style="background-color: rgba(24,43,84,0.92); color: #ffffff; font-size:16px;"><?php echo $g_mrc_total; ?>
                Tk
            </td>
