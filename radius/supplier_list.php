...
<table class="table table-bordered" id="btrc">
    ...
    while ($f = mysqli_fetch_array($r)) {
        ...
        <tr>
            ...
            <td>
                <button class="btn-warning" id="<?php echo $sup_id; ?>" style="color: #ffffff;"
                        onclick="ClearSession(this.id)">
                    All
                </button>
            ...
            <td><a class="btn btn-danger" href="supplier_list.php"
                   onClick="showMessage('<?php echo $sup_id; ?>','<?php echo $uid; ?>')"
                   id="<?php echo $uid; ?>">
