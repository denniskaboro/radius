                            ...
                            <form name="login" action="<?php echo $linkloginonly; ?>" onSubmit="doLogin()">
                                <div class="card-body" data-aos="zoom-in"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" required value="<?php echo $mac; ?>"
                                               class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="password" name="password" value="<?php echo $mac; ?>" required
                                               class="form-control">
                                    </div>
                                </div>
                                <p class="text-danger">If it's not redirect automatically please click the login
                                    button</p>
                                <div class="form-group">
